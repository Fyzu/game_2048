...
Start:
	...
	do {
		...
		if (max == 11)
			processing=false;												//При достижении максимального значения
			...
			printScreen(matrix, score, name_player);						//Обновить экран после каждого действия
...
* \param[in] name_player - имя игрока
